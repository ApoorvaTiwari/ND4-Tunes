    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent popIntent = new Intent(MainActivity.this, com.example.apoorva.tunes.Pop.class);
                //start pop activity
        ...
        jazz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent jazzIntent = new Intent(MainActivity.this, com.example.apoorva.tunes.Jazz.class);
                //start jazz activity
        ...
        rap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent rapIntent = new Intent(MainActivity.this, com.example.apoorva.tunes.Rap.class);
                //start rap activity
        ...
        rock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent rockIntent = new Intent(MainActivity.this, com.example.apoorva.tunes.Rock.class);
                //start rock activity
