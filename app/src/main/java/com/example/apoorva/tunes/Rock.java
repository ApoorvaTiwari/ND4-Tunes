package com.example.apoorva.tunes;
...
import com.example.apoorva.tunes.Song;
import com.example.apoorva.tunes.SongAdapter;
import com.example.apoorva.tunes.NowPlaying;
import com.example.apoorva.tunes.Song;
import com.example.apoorva.tunes.SongAdapter;
...
public class Rock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Song("Whatever It Takes","Imagine Dragons",R.drawable.rock_icon));
        songs.add(new Song("Feel It Still","Portugal. The Man",R.drawable.rock_icon));
        songs.add(new Song("Africa","Weezer",R.drawable.rock_icon));
        songs.add(new Song("Zombie","Bad Wolves",R.drawable.rock_icon));
        songs.add(new Song("Believer","Imagine Dragons",R.drawable.rock_icon));
